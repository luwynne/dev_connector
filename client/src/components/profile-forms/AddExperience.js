            ...
            <form className="form" onSubmit={e => {
                ...
                <div className="form-group">
                    <p>
                        ...
                        type="checkbox" name="current" value="" /> {' '}Current Job
                    </p>
                </div>
                ...
                <div className="form-group">
                    <textarea value={description} onChange={e => onChange(e)} name="description" cols="30" rows="5" placeholder="Job Description"></textarea>
                </div>
